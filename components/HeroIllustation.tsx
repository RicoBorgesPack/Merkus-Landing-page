  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#9b51e0"
      />
      <ellipse cx="295.09" cy="682.36" rx="23.11" ry="3.17" fill="#9b51e0" opacity="0.1" />
      <ellipse cx="206.55" cy="691.34" rx="23.11" ry="3.17" fill="#9b51e0" opacity="0.1" />
      <ellipse cx="102.27" cy="679.19" rx="23.11" ry="3.17" fill="#9b51e0" opacity="0.1" />
      <ellipse cx="241.99" cy="716.9" rx="16.43" ry="2.26" fill="#9b51e0" opacity="0.1" />
      <ellipse cx="150.1" cy="714.64" rx="16.43" ry="2.26" fill="#9b51e0" opacity="0.1" />
      <path
      ...
      <circle cx="21.63" cy="133.13" r="21.63" fill="#9b51e0" opacity="0.1" />
      <circle cx="608.74" cy="41.99" r="21.63" fill="#9b51e0" opacity="0.1" />
      <circle cx="951.89" cy="127.44" r="21.63" fill="#9b51e0" opacity="0.1" />
      <circle cx="64.88" cy="252.46" r="36.25" fill="#9b51e0" opacity="0.1" />
      <circle cx="507.64" cy="789.47" r="36.25" fill="#9b51e0" opacity="0.1" />
      <circle cx="990.55" cy="768.57" r="36.25" fill="#9b51e0" opacity="0.1" />
    </svg>
  )
}
